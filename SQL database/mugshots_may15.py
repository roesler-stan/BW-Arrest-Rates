...
mugshots_may2015 = sa.Table('mugshots_may2015', metadata,
...
mugshots_may2015 = sa.Table('mugshots_may2015', metadata, autoload=True, autoload_with=conn)

# To set foreign key to match to arrests - sa.ForeignKey("arrests_m1.arrest_id")
mugshots_charges_may2015 = sa.Table('mugshots_charges_may2015', metadata,
    sa.Column('arrest_id', sa.String(), sa.ForeignKey("mugshots_may2015.arrest_id"), nullable = False),
