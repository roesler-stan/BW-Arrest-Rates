-- Table: mugshots_may2015_ac_male_1415

-- DROP TABLE mugshots_may2015_ac_male_1415;

CREATE TABLE mugshots_may2015_ac_male_1415
(
  ...
  CONSTRAINT mugshots1415_male_pkey PRIMARY KEY (arrest_id)
)
WITH (
  OIDS=FALSE
);
ALTER TABLE mugshots_may2015_ac_male_1415
  OWNER TO roesler;

-- Index: county1415_male_idx

-- DROP INDEX county1415_male_idx;

CREATE INDEX county1415_male_idx
  ON mugshots_may2015_ac_male_1415
  USING btree
