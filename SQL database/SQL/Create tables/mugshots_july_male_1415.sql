-- Table: mugshots_july_male_1415

-- DROP TABLE mugshots_july_male_1415;

CREATE TABLE mugshots_july_male_1415
(
  ...
  date_year integer,
  date_month integer,
  CONSTRAINT mugshots_july_male_1415_pkey PRIMARY KEY (arrest_id)
)
WITH (
  OIDS=FALSE
);
ALTER TABLE mugshots_july_male_1415
  OWNER TO roesler;