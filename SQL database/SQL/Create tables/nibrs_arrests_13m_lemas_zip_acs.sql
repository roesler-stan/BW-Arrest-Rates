-- Table: nibrs_arrests_13m_lemas_zip_acs

-- DROP TABLE nibrs_arrests_13m_lemas_zip_acs;

CREATE TABLE nibrs_arrests_13m_lemas_zip_acs
(
  ...
  CONSTRAINT nibrs_arrests_13m_lemas_zip_acs_pkey PRIMARY KEY (internal_offender_id)
)
WITH (
  OIDS=FALSE
);
ALTER TABLE nibrs_arrests_13m_lemas_zip_acs
  OWNER TO roesler;

-- Index: nibrs_arrests_13m_lemas_zip_acs_idx

-- DROP INDEX nibrs_arrests_13m_lemas_zip_acs_idx;

CREATE INDEX nibrs_arrests_13m_lemas_zip_acs_idx
  ON nibrs_arrests_13m_lemas_zip_acs
  USING btree
