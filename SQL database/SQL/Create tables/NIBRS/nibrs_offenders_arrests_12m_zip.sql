-- Table: nibrs_offenders_arrests_12m_zip

-- DROP TABLE nibrs_offenders_arrests_12m_zip;

CREATE TABLE nibrs_offenders_arrests_12m_zip
(
...
ALTER TABLE nibrs_offenders_arrests_12m_zip
  OWNER TO roesler;

CREATE INDEX nibrs_offenders_arrests_12m_zip_idxo
  ON nibrs_offenders_arrests_12m_zip
  USING btree
  (ori COLLATE pg_catalog."default");

CREATE INDEX nibrs_offenders_arrests_12m_zip_idxz
  ON nibrs_offenders_arrests_12m_zip
  USING btree
  (zipcode);