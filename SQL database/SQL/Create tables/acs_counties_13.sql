-- Table: acs_counties_13

-- DROP TABLE acs_counties_13;

CREATE TABLE acs_counties_13
(
  ...
  CONSTRAINT acs_counties_13_pkey PRIMARY KEY (acs_county_no)
)
WITH (
  OIDS=FALSE
);
ALTER TABLE acs_counties_13
  OWNER TO roesler;