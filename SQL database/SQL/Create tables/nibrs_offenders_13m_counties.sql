-- Table: nibrs_offenders_13m_counties

-- DROP TABLE nibrs_offenders_13m_counties;

CREATE TABLE nibrs_offenders_13m_counties
(
  ...
  CONSTRAINT nibrs_offenders_13m_counties_pkey PRIMARY KEY (offenders_county_no)
)
WITH (
  OIDS=FALSE
);
ALTER TABLE nibrs_offenders_13m_counties
  OWNER TO roesler;
