-- Table: mugshots_july_male_1415_ac

-- DROP TABLE mugshots_july_male_1415_ac;

CREATE TABLE mugshots_july_male_1415_ac
(
  ...
  date_month integer,
	...
	CONSTRAINT mugshots_july_male_1415_ac_pkey PRIMARY KEY (arrest_id)
)
WITH (
  OIDS=FALSE
);
ALTER TABLE mugshots_july_male_1415_ac
  OWNER TO roesler;
