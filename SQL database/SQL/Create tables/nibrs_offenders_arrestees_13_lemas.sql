-- Table: nibrs_offenders_arrestees_13_lemas

-- DROP TABLE nibrs_offenders_arrestees_13_lemas;

CREATE TABLE nibrs_offenders_arrestees_13_lemas
(
...
ALTER TABLE nibrs_offenders_arrestees_13_lemas
  OWNER TO roesler;