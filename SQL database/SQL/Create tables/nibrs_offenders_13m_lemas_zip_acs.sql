-- Table: nibrs_offenders_13m_lemas_zip_acs

-- DROP TABLE nibrs_offenders_13m_lemas_zip_acs;

CREATE TABLE nibrs_offenders_13m_lemas_zip_acs
(
  ...
  CONSTRAINT nibrs_offenders_13m_lemas_zip_acs_pkey PRIMARY KEY (internal_offender_id)
)
WITH (
  OIDS=FALSE
);
ALTER TABLE nibrs_offenders_13m_lemas_zip_acs
  OWNER TO roesler;