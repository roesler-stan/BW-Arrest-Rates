-- Table: acs_counties_13_rpl_nibrs_arrests_13m

-- DROP TABLE acs_counties_13_rpl_nibrs_arrests_13m;

CREATE TABLE acs_counties_13_rpl_nibrs_arrests_13m
(
  ...
  CONSTRAINT acs_counties_rplna_13_pkey PRIMARY KEY (acs_county_no)
)
WITH (
  OIDS=FALSE
);
ALTER TABLE acs_counties_13_rpl_nibrs_arrests_13m
  OWNER TO roesler;