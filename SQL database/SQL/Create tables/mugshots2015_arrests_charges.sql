-- Table: mugshots2015_arrests_charges

-- DROP TABLE mugshots2015_arrests_charges;

CREATE TABLE mugshots2015_arrests_charges
(
  ...
  CONSTRAINT mugshots2015_pkey PRIMARY KEY (arrest_id)
)
WITH (
  OIDS=FALSE
);
