...
ivs <- c("black_not_white", "agency_offenders_count", "mean_inc", "agency_arrest")
continuous_ivs <- c("agency_offenders_count", "mean_inc", "agency_arrest")
...
iv_names <- c("Constant", "Offender Black (ref = White)",
              ...
              "Percent Arrested", "Offender Black x Percent Arrested")
