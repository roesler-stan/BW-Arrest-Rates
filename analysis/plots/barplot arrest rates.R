...
TAB <- rbind(offenders_arrested, simple_assault_arrested, aggravated_assault_arrested, intimidation_arrested,
             robbery_arrested, shoplifting_arrested, vandalism_arrested, drugs_narcotics_arrested, drug_equipment_arrested,
             weapon_arrested)
...
df.m$X2 <- factor(df.m$X2,
                  levels = c("offenders_arrested", "simple_assault_arrested", "aggravated_assault_arrested", 
                             "intimidation_arrested", "robbery_arrested", "shoplifting_arrested", 
                              "vandalism_arrested", "drugs_narcotics_arrested", "drug_equipment_arrested",
                             "weapon_arrested"),
                  labels = c("All", "Simple Assault", "Aggravated Assault", "Intimidation", "Robbery",
