...
setwd("~/Dropbox/Mugshots Project/Public/Output/models")

subsets <- list(simple_assault_data_with_victim_oneoffense, aggravated_assault_data_with_victim_oneoffense,
                intimidation_data_with_victim_oneoffense, robbery_data_with_victim_oneoffense)

models_wvictims_oneoffense <- lapply(subsets, function(subset) {
...
models_list_wvictims_oneoffense <- c(models_wvictims_oneoffense[[1]],
                                     models_wvictims_oneoffense[[2]],
                                     models_wvictims_oneoffense[[3]],
                                     models_wvictims_oneoffense[[4]])
htmlreg(models_list_wvictims_oneoffense, center = F, file = 'with_victims_indiv_oneoffense.doc', digits = 3,
...
# Models 2, 3 (simple assault), 8, 9 (intimidation), and 11, 12 (robbery) do not converge (max relgrad > 0.001)
lapply(models_list_wvictims_oneoffense, function(model) {
...
coef_models_wvictims_oneoffense <- lapply(models_wvictims_oneoffense, function(model) {
...
coef_models_wvictims_oneoffense <- c(coef_models_wvictims_oneoffense[[1]],
                                     coef_models_wvictims_oneoffense[[2]],
                          coef_models_wvictims_oneoffense[[3]], coef_models_wvictims_oneoffense[[4]])


htmlreg(coef_models_wvictims_oneoffense, file = 'with_victims_coef_oneoffense.doc', digits = 3,
...
lapply(coef_models_wvictims_oneoffense, function(model) {
  AIC(model)
})
...
intercept_models_wvictims_oneoffense <- lapply(models_wvictims_oneoffense, function(model) {
  # take the second model for the subset, with controls
...
intercept_models_wvictims_oneoffense <- c(intercept_models_wvictims_oneoffense[[1]],
                                          intercept_models_wvictims_oneoffense[[2]],
                               intercept_models_wvictims_oneoffense[[3]],
                               intercept_models_wvictims_oneoffense[[4]])


htmlreg(intercept_models_wvictims_oneoffense, file = 'with_victims_intercept_oneoffense.doc', digits = 3,
        custom.model.names = c('Simple Assault', 'Simple Assault',
                               'Aggravated Assault', 'Aggravated Assault',
                               'Intimidation', 'Intimidation', 'Robbery', 'Robbery'),
        caption = "Crimes with Victims", caption.above = T,
...
lapply(intercept_models_wvictims_oneoffense, function(model) {
  AIC(model)
})