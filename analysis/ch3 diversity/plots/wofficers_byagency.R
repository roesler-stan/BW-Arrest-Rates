...
plots <- lapply(seq_along(subsets_list), function(i) {
  ...
  p <- ggplot(plot_data, aes(x=w_officers_percent, y=arrested,
...
ggsave("wofficers_byagency.jpg", plot=g, dpi=150)
