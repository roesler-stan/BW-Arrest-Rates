...
setwd("~/Dropbox/Mugshots Project/Public/Output/models/final")
...
htmlreg(coef_models, file = 'without_victims_coef_male.doc', digits = 3,
...
htmlreg(models_list, center = F, file = 'without_victims_indiv_male.doc', digits = 3,
...
# Models 5 and 6 (vandalism) do not converge (max relgrad > 0.001)
